...
DEFAULT_OUT_DIR="$WORKSPACE_DIR/results/multitimeframe_resonance/live_market_scan"
PYTHON_CMD=(
...
show_help() {
  ...
  echo "示例:"
  echo "  $0"
  echo "  $0 --scan-date 20260310"
  echo "  $0 --symbols sh600000,sz000001 --out-dir /tmp/gp_quant_resonance_smoke"
  echo ""
  echo "当前推荐默认参数: top_n=30, min_amount=500000, min_turnover=1.0, resonance_min_count=2, hold_days=5, max_positions=10, max_positions_per_industry=2"
}
