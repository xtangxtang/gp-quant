...
DEFAULT_OUT_DIR="$WORKSPACE_DIR/results/rapid_expansion_hold"
PYTHON_CMD=(
...
CMD=(
  src/strategy/uptrend_hold_state_flow/rapid_expansion_hold/run_rapid_expansion_hold_scan.py
  --data_dir "$DATA_DIR"
  --out_dir "$OUT_DIR"
