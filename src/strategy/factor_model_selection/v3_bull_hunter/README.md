...
flowchart TB
    subgraph DATA["数据源"]
        FC["feature-cache/<br/>daily + weekly + 32 因子<br/>(v10: +9 运行时 + 5 行业 = 46)"]
...
| 运行时衍生 | `momentum_{5d,20d,60d}`, `price_vs_ma20`, `vol_price_synergy`, `volatility_ratio`, `mf_reversal_zscore`, `atr_20d`, `close_vs_high_60d` | 9 |
| ✨ 行业 (v10) | `industry_mom_{5d,20d}`, `industry_breadth_5d`, `industry_rs_20d`, `industry_vol_surge` | 5 |
