...
def evaluate_hold_path(df: pd.DataFrame, start_date: str, scan_date: str = "", exit_persist_days: int = 3) -> pd.DataFrame:
    ...
    out["strategy_score"] = pd.to_numeric(out["hold_score"], errors="coerce").fillna(0.0)
    out["strategy_name"] = "entropy_hold_judgement"
    return out