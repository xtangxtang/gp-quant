...
基于 [[12-papers-synthesis]] 的 8 个共识，实现 4 层渐进式选股：
...
| 输出状态 | 含义 |
|----------|------|
| `abandon` | [[strategic-abandonment]] — 完全不交易 |
| `distorted` | 市场扭曲，极度谨慎 |
| `expansion` | 扩张期 |
| `transition` | 转变期 |
| `compression` | 压缩期 |
...
| 指标 | 来源 | 含义 |
|------|------|------|
| `path_irreversibility_20` | [[path-irreversibility]] | 20 日不可逆性 |
| `dominant_eig_20` | [[dominant-eigenvalue]] | 20 日主特征值 |
| `perm_entropy` | [[permutation-entropy]] | 置换熵 |
| `phase_adjusted_ar1_20` | [[bifurcation]] | 相位校正 AR(1) |
...
- [[tick-entropy-module]] — 核心计算引擎
- [[multitimeframe-scanner]] — 互补策略
- [[hold-exit-system]] — 买入后的持仓管理

## 相关概念

- [[entropy]], [[bifurcation]], [[strategic-abandonment]], [[path-irreversibility]]
